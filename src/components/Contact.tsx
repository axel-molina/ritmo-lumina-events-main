      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            ¿Listo para hacer de tu evento algo inolvidable? Solicita una cotización personalizada 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start max-w-6xl mx-auto">
          <div className="bg-card/30 backdrop-blur-sm p-8 rounded-lg border border-border/50">
            <h3 className="text-2xl font-bold mb-6 text-dj-yellow">Solicita tu presupuesto</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="bachelor">Despedida de Soltero/a</SelectItem>
              ...
              <Button type="submit" className="w-full bg-dj-yellow text-black hover:bg-dj-yellow/80" disabled={loading}>
          ...
          <div className="lg:pl-8">
            <h3 className="text-2xl font-bold mb-6 text-dj-yellow">Información de Contacto</h3>
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">contacto@ritmolumina.com</p>
                </div>
              </div>
            ...
            <div className="mt-8 p-6 bg-dj-yellow/10 rounded-lg border border-dj-yellow/30">
              ...
              <p className="mb-4 text-sm">Contáctanos directamente por WhatsApp para una respuesta inmediata sobre disponibilidad y precios.</p>
              <Button 
                variant="outline" 
              ...
              >
                <a 
                  href="https://wa.me/1234567890?text=Hola,%20estoy%20interesado%20en%20contratar%20sus%20servicios%20para%20un%20evento." 
                  target="_blank" 
